...
dia = 1
for i in bacterias:
  if(indice + 1 >= len(bacterias)):
    break
  else:
    percentual_crescimento = 100 * (bacterias[indice + 1] - bacterias[indice]) / bacterias[indice]
    indice += 1
    percentuais.append(f"{percentual_crescimento:.2f}%")
print(percentuais)
